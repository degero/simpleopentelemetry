...
These configs only support gRPC OTLP receivers as to work with manual opentelemetry app instrumentation and not AWS SDK telemetry like the xray library. They are designed for PRODUCTION use with trace filters, memory limit and tail sampling to reduce load/cost of telemetry.
