...
using soteltestgcp.Models;

namespace soteltestgcp.Controllers;
...
public class HomeController : Controller
{
    ...
    {
        _logger = logger;
        _activitySource = new ActivitySource("soteltestgcp.Controllers.Home");
    }
    ...
    public IActionResult Index()
    {
        ...
        using (var activity = _activitySource.StartActivity("DoSomeWork"))
        {
            ...
            if (activity is not null && activity.IsAllDataRequested)
            {
                ...
                activity.AddEvent(new ActivityEvent("Work"));
            }
        }
